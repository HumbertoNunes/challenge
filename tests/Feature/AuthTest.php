...
class AuthTest extends BaseTestCase
{
    ...
    public function itShouldAuthenticateAUser()
    {
        ...
        $credentials->put('password', 'Challenge@2022'); // The password before be encrypted
    ...
    {
        $credentials = factory(UserFactory::class, ['password' => 'Challenge@2022'])->make()->only(['email', 'password']);
    ...
    public function itShouldNotAllowTheUserSignInWithFakeEmail()
    {
        ...
        $fake_credentials = $user->put('email', 'challenge@mail.com')->all();
    ...
    {
        $user = factory(UserFactory::class)->make();
        $fake_credentials = $user->put('password', 'Challenge@2021')->all();
