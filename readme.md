...
This documentation will guide you through the PHP Challenge which uses PHP 7.4 and Slim Framework. This application provides a simple API to get latest stock market values. So come along for the ride and let's setup the project.
...
```js
{
  "email": "humberto.souza@challenge.io",
  "password": "Challenge@2022",
  "password_confirmation": "Challenge@2022"
}
```
